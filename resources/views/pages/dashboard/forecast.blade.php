        ...
        <section class="min-h-screen w-full p-6">
            ...
            @else
                <x-ui.empty-state
                    ...
                    :message="__('Please select an account from the sidebar to view your forecast. If there is no account on the sidebar go to requests to import the accounts.', [
